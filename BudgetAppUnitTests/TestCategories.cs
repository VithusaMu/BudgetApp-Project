...
namespace BudgetCodeTests
{
    ...
    public class TestCategories
    {
        ...
        [Fact]
        public void CategoriesMethod_DeleteExistingExpenseDoesntCrash()
        {
            // Arrange
            String folder = TestConstants.GetSolutionDir();
            String goodDB = $"{folder}\\{TestConstants.testDBInputFile}";
            ...
            {
                Assert.True(false, "Existing Expense causes Delete to break");
            }
        }
        ...
        public void CategoriesMethod_UpdateCategory_InvalidIDDoesntCrash()
        {
            ...
            try
            {
                categories.UpdateProperties(idToUpdate, newDescr, Category.CategoryType.Income);
                Assert.Equal(sizeOfList, categories.List().Count);
            }
